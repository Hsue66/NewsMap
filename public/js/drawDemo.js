...
-------------------------------------------------------------------------
File: drawDemo.js
 - a Javascript file to draw a sample Map which was made by uploaded files
...
.then(function(elem){
  // Set the default value of Cytoscape
  var cy = cytoscape({
  ...
  // click expandAll button, expand nodes and highlight timelines
  document.getElementById("expandAll").addEventListener("click", function () {
    api.expandAll();
    highlightTimeline(cy);
  });

  // click collapseAll button, collapse nodes and highlight timelines
